...
async function getdataa(){
    ...
    try{
        let url=`https://newsapi.org/v2/everything?q=entertainment&language=en&top-headlines?country=in&pageSize=15&apiKey=fdd9ef74d3944c40b1de34bfaadbab18`
...
var bollywood=document.getElementById("bolly")

bollywood.addEventListener("click",searc)


function searc(){

window.open("bollywood.html","_self")
